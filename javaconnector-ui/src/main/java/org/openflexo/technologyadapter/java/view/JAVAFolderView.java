...
public class JAVAFolderView extends JTabbedPane implements ModuleView<JAVAFolderModel>{
	 ...
	 * @param perspective
	 */
	public JAVAFolderView(JAVAFolderModel javaFolderModel, FlexoController controller, FlexoPerspective perspective) {
